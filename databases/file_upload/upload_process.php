...
if(isset($_FILES['file']) && $_FILES['file']['name'] != "") {
    ...
    if(move_uploaded_file($file['tmp_name'], $upload_directory.$path)) 
    {
        ...
        //파일 업로드 insert query
        $query = "INSERT INTO PSM_UPLOAD_FILE (file_user_id, file_origin_name, file_save_name, reg_id, mod_id) VALUES(?,?,?,?,?)";
        ...
        $user_update = "UPDATE PSM_USER SET file_user_id=? WHERE idx=?";
