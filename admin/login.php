              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" action="../databases/register/login_db.php" method="POST">
                    ...
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" id="user_pw" name="login_pw" placeholder="Password">
                    </div>
                    <div class="form-group">
                    ...
                    <a onclick="submit_func()" class="btn btn-primary btn-user btn-block">
                      Login
                    </a>
                    <hr>
